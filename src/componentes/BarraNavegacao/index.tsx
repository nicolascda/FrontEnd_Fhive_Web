    ...
    return (
        <header className={styles['barra-navegacao']}>
            ...
            <nav className={styles['menu']}>
                ...
                <Link to="/produtos" className={styles['menu-item']}>
                    <span>Produtos</span>

                    <span className={styles['seta']} />
                </Link>

                <Link to="/solucao" className={styles['menu-item']}>
                    <span>Solução</span>

                    <span className={styles['seta']} />
                </Link>

                <Link to="/quem-somos" className={styles['menu-item']}>
                    Quem Somos?
                </Link>

            </nav>

            {/* Divisória antes do botão */}
            <span className={styles['divisoria-direita']} />
